 ...
 */
public class RozrywkoweFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        handlerNuty.fetchXML("rozrywkowa.xml");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        startDownload(handlerNuty.nutyList.get(position).getFil(), "http://chaps.zut.edu.pl/Nuty/chapsapp/rozrywkowa/"+ handlerNuty.nutyList.get(position).getFil() );
    }
