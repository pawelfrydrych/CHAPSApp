...
public class WspolczesneFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        handlerNuty.fetchXML("wspolczesna.xml");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        startDownload(handlerNuty.nutyList.get(position).getFil(), "http://chaps.zut.edu.pl/Nuty/chapsapp/wspolczesna/"+ handlerNuty.nutyList.get(position).getFil() );
    }
