...
public class KoledyFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        handlerNuty.fetchXML("koledy.xml");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        startDownload(handlerNuty.nutyList.get(position).getFil(), "http://chaps.zut.edu.pl/Nuty/chapsapp/koledy/"+ handlerNuty.nutyList.get(position).getFil() );
    }
