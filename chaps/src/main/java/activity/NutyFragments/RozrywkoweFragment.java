...
public class RozrywkoweFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        for(String key : nuty.rozrywkowe.keySet())
        {
        ...
        for(int i = 0; i < nuty.rozrywkowe.size(); i++)
        {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        startDownload(listaUtworow.get(position),nuty.rozrywkowe.get(listaUtworow.get(position)));
